...
def analyze_0206(abf: pyabf.ABF, fig: pyABFauto.figure.Figure):
    pyABFauto.analyses.iv.step(abf, fig, 1.5, 2.0, 2.08, 2.18)


def analyze_0208(abf: pyabf.ABF, fig: pyABFauto.figure.Figure):
    pyABFauto.analyses.iv.step_fast(abf, fig)
...
def analyze_0406a(abf: pyabf.ABF, fig: pyABFauto.figure.Figure):
    pyABFauto.analyses.memtest.figureOverTime(abf, fig)


def analyze_0407(abf: pyabf.ABF, fig: pyABFauto.figure.Figure):
    pyABFauto.analyses.memtest.figureOverTime(abf, fig)


def analyze_0409(abf: pyabf.ABF, fig: pyABFauto.figure.Figure):
    pyABFauto.analyses.memtest.figureOverTime(abf, fig)
...
def analyze_0520(abf: pyabf.ABF, fig: pyABFauto.figure.Figure):
    pyABFauto.analyses.apGain.doubleStep(abf, fig, 2.10, 3.13, 5.61, 6.63)
...
def analyze_0916(abf: pyabf.ABF, fig: pyABFauto.figure.Figure):
    pyABFauto.analyses.todd.vc_ican(abf, fig)
